...
Rates are USD per 1M tokens, from api-docs.deepseek.com (verified 2026-06-22).
...
PRICING: dict[str, tuple[float, float, float]] = {
    ...
    # Legacy ids retire 2026-07-24; until then they route to v4-flash, so price them as flash.
